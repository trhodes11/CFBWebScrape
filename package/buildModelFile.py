...
def build_model_df():
    ...
    df_historical_games.loc[df_historical_games['away_team'] == "Appalachian State", 'away_team'] = "App State"
    df_historical_games.loc[df_historical_games['away_team'] == "Arizona State", 'away_team'] = "Arizona St"
    df_historical_games.loc[df_historical_games['away_team'] == "Arkansas State", 'away_team'] = "Arkansas St"
    df_historical_games.loc[df_historical_games['away_team'] == "Boston College", 'away_team'] = "Boston Col"
    df_historical_games.loc[df_historical_games['away_team'] == "Bowling Green", 'away_team'] = "Bowling Grn"
    df_historical_games.loc[df_historical_games['away_team'] == "UCF", 'away_team'] = "Central FL"
    df_historical_games.loc[df_historical_games['away_team'] == "Central Michigan", 'away_team'] = "Central Mich"
    df_historical_games.loc[df_historical_games['away_team'] == "Coastal Carolina", 'away_team'] = "Coastal Car"
    df_historical_games.loc[df_historical_games['away_team'] == "Colorado State", 'away_team'] = "Colorado St"
    df_historical_games.loc[df_historical_games['away_team'] == "East Carolina", 'away_team'] = "E Carolina"
    df_historical_games.loc[df_historical_games['away_team'] == "Eastern Michigan", 'away_team'] = "E Michigan"
    df_historical_games.loc[df_historical_games['away_team'] == "Florida Atlantic", 'away_team'] = "Fla Atlantic"
    df_historical_games.loc[df_historical_games['away_team'] == "Florida International", 'away_team'] = "Florida Intl"
    df_historical_games.loc[df_historical_games['away_team'] == "Florida State", 'away_team'] = "Florida St"
    df_historical_games.loc[df_historical_games['away_team'] == "Fresno State", 'away_team'] = "Fresno St"
    df_historical_games.loc[df_historical_games['away_team'] == "Georgia Southern", 'away_team'] = "GA Southern"
    df_historical_games.loc[df_historical_games['away_team'] == "Georgia Tech", 'away_team'] = "GA Tech"
    df_historical_games.loc[df_historical_games['away_team'] == "Hawai'i", 'away_team'] = "Hawaii"
    df_historical_games.loc[df_historical_games['away_team'] == "Kansas State", 'away_team'] = "Kansas St"
    df_historical_games.loc[df_historical_games['away_team'] == "Lafayette", 'away_team'] = "LA Lafayette"
    df_historical_games.loc[df_historical_games['away_team'] == "Louisiana Monroe", 'away_team'] = "LA Monroe"
    df_historical_games.loc[df_historical_games['away_team'] == "Louisiana Tech", 'away_team'] = "LA Tech"
    df_historical_games.loc[df_historical_games['away_team'] == "Miami", 'away_team'] = "Miami (FL)"
    df_historical_games.loc[df_historical_games['away_team'] == "Michigan State", 'away_team'] = "Michigan St"
    df_historical_games.loc[df_historical_games['away_team'] == "Middle Tennessee", 'away_team'] = "Middle Tenn"
    df_historical_games.loc[df_historical_games['away_team'] == "Mississippi State", 'away_team'] = "Miss State"
    df_historical_games.loc[df_historical_games['away_team'] == "Ole Miss", 'away_team'] = "Mississippi"
    df_historical_games.loc[df_historical_games['away_team'] == "North Carolina", 'away_team'] = "N Carolina"
    df_historical_games.loc[df_historical_games['away_team'] == "New Mexico State", 'away_team'] = "N Mex State"
    df_historical_games.loc[df_historical_games['away_team'] == "Oklahoma State", 'away_team'] = "Oklahoma St"
    df_historical_games.loc[df_historical_games['away_team'] == "Oregon State", 'away_team'] = "Oregon St"
    df_historical_games.loc[df_historical_games['away_team'] == "South Alabama", 'away_team'] = "S Alabama"
    df_historical_games.loc[df_historical_games['away_team'] == "South Carolina", 'away_team'] = "S Carolina"
    df_historical_games.loc[df_historical_games['away_team'] == "South Florida", 'away_team'] = "S Florida"
    df_historical_games.loc[df_historical_games['away_team'] == "SMU", 'away_team'] = "S Methodist"
    df_historical_games.loc[df_historical_games['away_team'] == "Southern Mississippi", 'away_team'] = "S Mississippi"
    df_historical_games.loc[df_historical_games['away_team'] == "San Diego State", 'away_team'] = "San Diego St"
    df_historical_games.loc[df_historical_games['away_team'] == "San Jose State", 'away_team'] = "San Jose St"
    df_historical_games.loc[df_historical_games['away_team'] == "TCU", 'away_team'] = "TX Christian"
    df_historical_games.loc[df_historical_games['away_team'] == "UTEP", 'away_team'] = "TX El Paso"
    df_historical_games.loc[df_historical_games['away_team'] == "UT San Antonio", 'away_team'] = "TX-San Ant"
    df_historical_games.loc[df_historical_games['away_team'] == "UMass", 'away_team'] = "U Mass"
    df_historical_games.loc[df_historical_games['away_team'] == "Virginia Tech", 'away_team'] = "VA Tech"
    df_historical_games.loc[df_historical_games['away_team'] == "Western Kentucky", 'away_team'] = "W Kentucky"
    df_historical_games.loc[df_historical_games['away_team'] == "Western Michigan", 'away_team'] = "W Michigan"
    df_historical_games.loc[df_historical_games['away_team'] == "West Virginia", 'away_team'] = "W Virginia"
    df_historical_games.loc[df_historical_games['away_team'] == "Washington State", 'away_team'] = "Wash State"
    ...
    df_historical_games.loc[df_historical_games['away_team'] == "LA Lafayette", 'away_conference'] = "Sun Belt"
    df_historical_games.loc[df_historical_games['away_team'] == "GA Southern", 'away_conference'] = "Sun Belt"
    df_historical_games.loc[df_historical_games['away_team'] == "Liberty", 'away_conference'] = "FBS Independents"
    df_historical_games.loc[df_historical_games['away_team'] == "Old Dominion", 'away_conference'] = "Conference USA"
    df_historical_games.loc[df_historical_games['away_team'] == "App State", 'away_conference'] = "Sun Belt"
    df_historical_games.loc[df_historical_games['away_team'] == "Idaho", 'away_conference'] = "Big Sky"
    df_historical_games.loc[df_historical_games['away_team'] == "Coastal Car", 'away_conference'] = "Sun Belt"
    df_historical_games.loc[df_historical_games['away_team'] == "Georgia State", 'away_conference'] = "Sun Belt"
    ...
    df_teams_away = Teams
    df_teams_away['away_team'] = df_teams_away['School']
    df_teams_away['away_city'] = df_teams_away['City']
    df_teams_away['away_state'] = df_teams_away['State']

    df_teams_away.loc[
        df_teams_away['away_team'] == "Appalachian State", 'away_team'] = "App State"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Arizona State", 'away_team'] = "Arizona St"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Arkansas State", 'away_team'] = "Arkansas St"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Boston College", 'away_team'] = "Boston Col"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Bowling Green", 'away_team'] = "Bowling Grn"
    df_teams_away.loc[
        df_teams_away['away_team'] == "UCF", 'away_team'] = "Central FL"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Central Michigan", 'away_team'] = "Central Mich"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Coastal Carolina", 'away_team'] = "Coastal Car"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Colorado State", 'away_team'] = "Colorado St"
    df_teams_away.loc[
        df_teams_away['away_team'] == "East Carolina", 'away_team'] = "E Carolina"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Eastern Michigan", 'away_team'] = "E Michigan"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Florida Atlantic", 'away_team'] = "Fla Atlantic"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Florida International", 'away_team'] = "Florida Intl"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Florida State", 'away_team'] = "Florida St"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Fresno State", 'away_team'] = "Fresno St"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Georgia Southern", 'away_team'] = "GA Southern"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Georgia Tech", 'away_team'] = "GA Tech"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Hawai'i", 'away_team'] = "Hawaii"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Kansas State", 'away_team'] = "Kansas St"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Louisiana", 'away_team'] = "LA Lafayette"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Louisiana Monroe", 'away_team'] = "LA Monroe"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Louisiana Tech", 'away_team'] = "LA Tech"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Miami", 'away_team'] = "Miami (FL)"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Michigan State", 'away_team'] = "Michigan St"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Middle Tennessee", 'away_team'] = "Middle Tenn"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Mississippi State", 'away_team'] = "Miss State"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Ole Miss", 'away_team'] = "Mississippi"
    df_teams_away.loc[
        df_teams_away['away_team'] == "North Carolina", 'away_team'] = "N Carolina"
    df_teams_away.loc[
        df_teams_away['away_team'] == "New Mexico State", 'away_team'] = "N Mex State"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Northern Illinois", 'away_team'] = "N Illinois"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Oklahoma State", 'away_team'] = "Oklahoma St"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Oregon State", 'away_team'] = "Oregon St"
    df_teams_away.loc[
        df_teams_away['away_team'] == "South Alabama", 'away_team'] = "S Alabama"
    df_teams_away.loc[
        df_teams_away['away_team'] == "South Carolina", 'away_team'] = "S Carolina"
    df_teams_away.loc[
        df_teams_away['away_team'] == "South Florida", 'away_team'] = "S Florida"
    df_teams_away.loc[
        df_teams_away['away_team'] == "SMU", 'away_team'] = "S Methodist"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Southern Mississippi", 'away_team'] = "S Mississippi"
    df_teams_away.loc[
        df_teams_away['away_team'] == "San Diego State", 'away_team'] = "San Diego St"
    df_teams_away.loc[
        df_teams_away['away_team'] == "San Jose State", 'away_team'] = "San Jose St"
    df_teams_away.loc[
        df_teams_away['away_team'] == "TCU", 'away_team'] = "TX Christian"
    df_teams_away.loc[
        df_teams_away['away_team'] == "UTEP", 'away_team'] = "TX El Paso"
    df_teams_away.loc[
        df_teams_away['away_team'] == "UT San Antonio", 'away_team'] = "TX-San Ant"
    df_teams_away.loc[
        df_teams_away['away_team'] == "UMass", 'away_team'] = "U Mass"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Virginia Tech", 'away_team'] = "VA Tech"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Western Kentucky", 'away_team'] = "W Kentucky"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Western Michigan", 'away_team'] = "W Michigan"
    df_teams_away.loc[
        df_teams_away['away_team'] == "West Virginia", 'away_team'] = "W Virginia"
    df_teams_away.loc[
        df_teams_away['away_team'] == "Washington State", 'away_team'] = "Wash State"
    ...
    df_joined = pd.merge(df_joined,
                         df_teams_away[['away_team', 'away_city', 'away_state']],
                         on=['away_team'],
                         how='left')
    ...
    df_joined = pd.merge(df_joined,
                         home_team_scraped_TR.rename({'Team': 'home_team'}, axis=1),
                         on=['home_team', 'Week', 'Season'],
                         how='left')

    df_joined = pd.merge(df_joined,
                         away_team_scraped_TR.rename({'Team': 'away_team'}, axis=1),
